...
const AllUserPage = () => {
  ...
  const updateStats = (data) => {
    ...
    const regular =
      data?.filter((u) => u.role === "user" || !u.role).length || 0;
  ...
  const handleDeleteUser = async () => {
    ...
    setStats((prev) => {
      ...
      return {
        ...
        [roleKey]: prev[roleKey] - 1,
        premium:
          userToDelete?.plan === "premium" ? prev.premium - 1 : prev.premium,
      };
    });
    ...
    try {
      ...
      setUsers((prev) =>
        [...prev, userToDelete].sort((a, b) => a._id.localeCompare(b._id)),
      );
      // Revert stats
      setStats((prev) => {
        if (!prev) return prev;
        ...
        >
          {STAT_CONFIG.map(({ key, label, icon: Icon, change }) => (
            <motion.div
              ...
              whileHover={{
                y: -3,
                boxShadow: "0 12px 24px -10px rgba(17,90,136,0.2)",
              }}
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-gray-100 bg-[#f8fafc]">
                  {["User", "Role", "Plan", "Prompts", "Joined", "Actions"].map(
                    (h) => (
                      <th
                        key={h}
          ...
          >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    ...
                    <strong className="text-[#115a88] capitalize">
                      {roleModal.role}
                    </strong>
                    ?
                  </p>
              ...
              <div className="mt-6 flex justify-end gap-2">
                ...
                <button
                  onClick={() =>
                    handleRoleUpdate(roleModal.userId, roleModal.role)
                  }
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-red-400 mt-2 bg-red-50 px-3 py-2 rounded-lg border border-red-100">
                   <span className="flex items-center gap-1"> <MessageSquareWarning /> Permanently deletes the user and all their prompts,
                    bookmarks, and data.</span>
                  </p>
                </div>
              </div>
              <div className="mt-6 flex justify-end gap-2">
