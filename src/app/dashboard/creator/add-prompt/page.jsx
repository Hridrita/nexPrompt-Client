...
export default function AddPromptForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      >
        <div>
          <h2 className="text-2xl font-semibold text-[#115a88] flex items-center gap-2">
        ...
        {/* Creator Badge - Unlimited Prompts */}
        <motion.div
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex items-center gap-2 bg-purple-50/50 border border-purple-200 rounded-xl px-4 py-2.5"
        >
          <span className="text-xs font-medium text-purple-600"><span className="flex items-center gap-1"><Infinity />Creator Plan:</span> </span>
